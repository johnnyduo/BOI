...
|--------|----------|-------------------------|--------------------------------|----------------------------------|
| **งวดที่ 1** (ภายใน 6 เดือน นับจากวันที่ออกบัตรส่งเสริม) | ดูรายละเอียดด้านล่าง | 13.0 | 50% | 6.5 |
| **งวดที่ 2** (ภายใน 12 เดือน นับจากวันที่ออกบัตรส่งเสริม) | ดูรายละเอียดด้านล่าง | 13.0 | 50% | 6.5 |
| **รวมทั้งสิ้น** | | **26.0** | **100%** | **13.0** |

### งวดที่ 1: ตัวชี้วัดความคืบหน้าของโครงการ

**1. ตัวชี้วัดความคืบหน้าของโครงการ:**
*(ดูตัวอย่างจากคู่มือการกรอกขอเสนอโครงการ ข้อ 1)*

- จัดซื้อและติดตั้ง On-premise Hardware 50% (Servers, Network Equipment)
- ตั้งค่า Cloud Infrastructure (AWS/GCP) พร้อมใช้งาน
- ติดตั้ง Basic Security Systems (Firewall, IDS/IPS)
- Setup Development Environment สำหรับทีมพัฒนา
- Deploy Beta version บน Staging Environment
...
### สรุปการเบิกจ่ายเงินสนับสนุนเทคโนโลยีดิจิทัล

| รายการ | มูลค่า (ล้านบาท) |
|--------|-----------------|
| งบประมาณเทคโนโลยีดิจิทัลทั้งหมด | 26.0 |
| อัตราการสนับสนุน | 50% |
| เงินสนับสนุนสูงสุดที่จะได้รับ | 13.0 |
| งวดที่ 1 (50%) | 6.5 |
| งวดที่ 2 (50%) | 6.5 |
